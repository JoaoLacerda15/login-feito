...
export default function RegisterScreen() {
  ...
  // Registrar usuário no Realtime Database
...
const styles = StyleSheet.create({
  ...
  dropdownContainer: { flexDirection: "row", justifyContent: "space-around", marginBottom: 12 },
  option: { padding: 10, borderWidth: 1, borderColor: "#aaa", borderRadius: 6 },
  optionSelected: { backgroundColor: "#cde" },
  tagsContainer: { flexDirection: "row", flexWrap: "wrap", gap: 8, marginBottom: 12 },
  tag: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 20, borderWidth: 1, borderColor: "#aaa", margin: 4 },
  tagSelected: { backgroundColor: "#007bff", borderColor: "#007bff" },
});
